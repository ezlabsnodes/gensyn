...
rm -rf officialauto.zip nonofficialauto.zip systemd.zip test.zip \
       qwen2-5-1-5-b.zip original2.zip ezlabs.zip ezlabs2.zip ezlabs3.zip ezlabs4.zip gpu1.zip \
...
# =========================
cd /root
wget -q https://github.com/ezlabsnodes/gensyn/raw/refs/heads/main/gpu1.zip
unzip -o gpu1.zip >/dev/null
rm -f gpu1.zip
