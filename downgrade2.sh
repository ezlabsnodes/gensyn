...
# =========================
rm -rf officialauto.zip nonofficialauto.zip systemd.zip test.zip downgrade-qwen2-unofficial.zip \
       original.zip original2.zip ezlabs.zip ezlabs2.zip ezlabs3.zip ezlabs4.zip \
       ezlabs5.zip ezlabs6.zip qwen2-unofficial.zip qwen2-official.zip || true
...
# =========================
cd /root
wget -q https://github.com/ezlabsnodes/gensyn/raw/refs/heads/main/downgrade-qwen2-unofficial.zip
unzip -o downgrade-qwen2-unofficial.zip >/dev/null
rm -f downgrade-qwen2-unofficial.zip
