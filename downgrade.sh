...
# =========================
rm -rf officialauto.zip nonofficialauto.zip systemd.zip test.zip downgrade-qwen2-official.zip \
...
# =========================
cd /root
wget -q https://github.com/ezlabsnodes/gensyn/raw/refs/heads/main/downgrade-qwen2-official.zip
unzip -o downgrade-qwen2-official.zip >/dev/null
rm -f downgrade-qwen2-official.zip
