...
# =========================
rm -rf officialauto.zip nonofficialauto.zip systemd.zip test.zip downgrade-qwen3-unofficial.zip \
...
# =========================
cd /root
wget -q https://github.com/ezlabsnodes/gensyn/raw/refs/heads/main/downgrade-qwen3-unofficial.zip
unzip -o downgrade-qwen3-unofficial.zip >/dev/null
rm -f downgrade-qwen3-unofficial.zip
