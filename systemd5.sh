...
rm -rf officialauto.zip nonofficialauto.zip systemd.zip nonofficialauto.zip qwen2-unofficial.zip qwen2-5-1-5-b.zip
...
wget https://github.com/ezlabsnodes/gensyn/raw/refs/heads/main/qwen2-5-1-5-b.zip && \
unzip qwen2-5-1-5-b.zip && \
cd ~/rl-swarm
