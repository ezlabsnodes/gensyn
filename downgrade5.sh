...
# =========================
rm -rf officialauto.zip nonofficialauto.zip systemd.zip test.zip downgrade-qwen2-5-1-5-b.zip \
...
# =========================
cd /root
wget -q https://github.com/ezlabsnodes/gensyn/raw/refs/heads/main/downgrade-qwen2-5-1-5-b.zip
unzip -o downgrade-qwen2-5-1-5-b.zip >/dev/null
rm -f downgrade-qwen2-5-1-5-b.zip
